          ...
          <Switch>
            ...
            <Main>
              ...
              <AppProviderContext>
                ...
                <Route
                  exact
                  path="/classroom/:id/chat"
                  component={ClassroomChat}
                />
                <Route
                  exact
                  path="/classroom/:id/homework"
                  component={Classwork}
                />
                <Route exact path="/classroom/:id/people" component={People} />
                <Route
                  exact
                  path="/classroom/:id/setting"
                  component={Setting}
                />
                <Route
                  exact
                  path="/classroom/:id/exam/create"
                  component={CreateExam2}
                />
                <Route
                  exact
                  path="/classroom/:id/exam/:examId/edit"
                  component={ExamEdit}
                />
