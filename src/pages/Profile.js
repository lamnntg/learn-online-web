...
import { Row, Col, Card, Button, List, Descriptions, Avatar, Radio, Switch, Upload, Image, Form, Input, InputNumber, Modal } from 'antd';
					...
					<Row justify='space-between' align='middle' gutter={[24, 0]}>
						<Col span={24} md={12} className='col-info'>
							<Avatar.Group style={{ position: 'relative' }}>
								<Row style={{ opacity: 0, position: 'absolute', zIndex: 999, top: 0, left: 0, width: '72px', height: '72px' }}>
									<Upload
										name='avatar'
								...
								<div className='avatar-info'>
									<h4 className='font-semibold m-0'>
										{user.name} <EyeOutlined className='hoverIcon' title='Xem ảnh đại diện' onClick={() => setVisible(true)} />
									</h4>
				...
				<Col span={24} md={12} className='mb-24'>
					...
					<Modal
						...
						<Form {...layout} name='nest-messages'>
							<Form.Item name={['user', 'name']} label='Tên người dùng'>
							...
							<Form.Item name={['user', 'description']} label='Mô tả bản thân'>
